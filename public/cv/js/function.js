...
$(function() {
    ...
    $('a#addHocVan').click(function() {
      $('<li>' + '<br/><div class="form-group"> <div class="well"> <div class="form-group"><label for="truong_tot_nghiep">Trường tốt nghiệp:</label> <input type="text" class="form-control" id="truong_tot_nghiep" name="truong_tot_nghiep[]" /></div> <div class="form-group"><label for="nganh_tot_nghiep">Ngành tốt nghiệp:</label><input type="text" class="form-control" id="nganh_tot_nghiep" name="nganh_tot_nghiep[]"/></div> <div class="form-group"> <label for="nam_tot_nghiep">Năm Nhập học:</label> <input type="month" class="form-control" id="nam_tot_nghiep" name="nam_nhap_hoc[]" /></div><div class="form-group"><label for="nam_tot_nghiep">Năm tốt nghiệp:</label> <input type="month" class="form-control" id="nam_tot_nghiep" name="nam_tot_nghiep[]" /></div> <div class="clearfix"></div> </div>   </div>' + '</li>').appendTo('ol#addRemoveHocVan');
      i++;
    });
