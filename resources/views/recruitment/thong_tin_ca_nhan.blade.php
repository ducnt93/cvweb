                ...
                <div class="panel-body">
                    <span class="form-horizontal">
                        ...
                        <div class="form-group form-inline">
                            ...
                            <div class="col-sm-10">
                                <div class='input-group date'>
                                    <input type='date' class="form-control" id='inputNgaysinh' name="inputNgaysinh" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="inputDiachi" >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputQuequan" placeholder="Ba Dinh, Ha Noi" name="inputQuequan" point="5" >
                            </div>
                        </div>
                        <div class="form-group">
